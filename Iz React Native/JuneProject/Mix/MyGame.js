...
import Enemy from './MyGame/Enemy';
...
export default class MyGame extends Component {
  ...
  render() {
    return (
        <Image source={require('./MyGame/src/background.png')} style={styles.container}>
        ...
        <View style={{ flex:1,alignItems:'center',marginTop:80}}>
          ...
          <Animated.Image source={require('./MyGame/src/mainchar.png')}
          style={{
              height: 100,
              width: 100,
              position: 'absolute',
          ...
          <Enemy enemyImg={require('./MyGame/src/enemy.png')}
